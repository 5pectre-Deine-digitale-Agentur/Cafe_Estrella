...
class Admin_2020{
	...
	/**
	 * Loads Admin 2020 login dependancies
	 * @since 1.4
	 */
	...
	/**
	 * Builds Admin 2020 Login page
	 * @since 1.4
	 */
	 
	public function build_login_app(){
		
		$utilities = new Admin_2020_utilities($this->version,$this->path,$this->productid);
		$utilities->start();
		
		$login = new Admin_2020_module_admin_login($this->version,$this->path,$utilities);
		$login->build_front();
	...
	public function build_front_app(){
		...
		$admin_styles = new Admin_2020_styles($this->version,$this->path,$utilities);
		$admin_styles->start_front();
		
		$admin_bar = new Admin_2020_module_admin_bar($this->version,$this->path,$utilities);
